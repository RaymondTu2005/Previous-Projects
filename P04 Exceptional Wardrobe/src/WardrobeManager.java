...
/**
 * Driver class for users to manage their wardrobe using a text interface. For use in the Wardrobe
 * Manager project.
 *
 * @author Michelle
 */
public class WardrobeManager {
  ...
  private static boolean keepRunning;
      //a boolean to keep track of if the program should continue running
  ...
  /**
   * Parses and executes the remove infrequently worn clothing command. Will print out a message if
   * something went wrong parsing or executing the command.
   *
   * @param input the command String given by the user that has already been trimmed of trailing
   *              whitespace
   */
  ...
  /**
   * Parses and executes the remove old clothing command. Will print out a message if something went
   * wrong parsing or executing the command.
   *
   * @param input the command String given by the user that has already been trimmed of trailing
   *              whitespace
   */
  ...
  /**
   * Parses and executes the remove clothing command. Will print out a message if something went
   * wrong parsing or executing the command.
   *
   * @param input the command String given by the user that has already been trimmed of trailing
   *              whitespace
  ...
  /**
   * Parses and executes the wear clothing command. Will print out a message if something went wrong
  ...
  /**
   * Parses and executes the add clothing command. Will print out a message if something went wrong
   * parsing or executing the command.
   *
   * @param input the command String given by the user that has already been trimmed of trailing
   *              whitespace
  ...
  /**
   * Parses and executes the find clothing command. Will print out a message if something went wrong
   * parsing or executing the command.
   *
   * @param input the command String given by the user that has already been trimmed of trailing
   *              whitespace
